...
public class CurrencyImpl implements Currency {
	...
	public String toString() {
		return value + " " + denomination + " " + createDate;
	}
	...
	public boolean equals(Object o) {
		...
		CurrencyImpl p = (CurrencyImpl) o;
		return (p.value == value) && (p.denomination.equals(denomination)) || (p.createDate.equals(createDate));
	}
